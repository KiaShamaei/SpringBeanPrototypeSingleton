...
import org.example.component1.SingletonBean;
...
public class App1
{
    public static void main( String[] args )
    {
        ...
        System.out.println("first get  : " + "singleton: " + x1 + " prototype " + x1.doSomthing());
        System.out.println("first get  : " + "singleton: " + x2 + " prototype " + x2.doSomthing());
